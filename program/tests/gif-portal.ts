...
describe('gif-portal', () => {
  ...
  it('Adding a gif increments total gif count', async () => {
    // Given
    let accountBefore = await program.account.myAccount.fetch(myAccount.publicKey);
    ...
    // Then
    let accountAfter = await program.account.myAccount.fetch(myAccount.publicKey);
  ...
  it('Likes a gif', async () => {
    ...
    // Then
    let accountCurrent = await program.account.myAccount.fetch(myAccount.publicKey);
